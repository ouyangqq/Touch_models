...
def HH(s_T,s_dt,_I = 7, g_Na = 120., g_K = 36., g_Leak = 0.3, E_Na = 50., E_K = -77.,
    E_Leak = -54.387):
    ...
    def I(t):
        return _I*(0.1*s_T<t<s_T-0.1*s_T)
...
def I_values(s_T,s_dt,time=None, _I=7):
    I = np.zeros(len(time))
